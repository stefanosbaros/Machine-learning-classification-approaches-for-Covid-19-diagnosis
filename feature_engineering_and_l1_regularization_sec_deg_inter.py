...
Covid_data.to_csv(main_file + "Covid_data_sec_deg_interactions.csv")
...
#Logistic regression model with l1 and l2 regularization and different penalties

#C = [i/1000 for i in range(1,30)]
...
# optimal value 0.008, weights=0.04, recall score with l2=0.78
# optimal value 0.01,  weights=0.04, recall score with l1=0.78
...
with open("features_sec_deg.txt", "wb") as fp:  
